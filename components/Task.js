  ...
  return (
    ...
    >
      <a href="" className="trello__task">
        {(task.label1 || task.label2) && (
          <div className="trello__card-labels">
            {task.label1 && (
              <span className="trello__card-label trello__card-label--orange"></span>
            )}
            {task.label2 && (
              <span className="trello__card-label trello__card-label--violet"></span>
            )}
          </div>
        )}
        ...
        <div className="trello__badges">
          {task.checkList && (
            <div
              className="trello__badge-checklist"
              title="Elementy listy zadań"
            >
              <img
                src="../static/images/check.png"
                className="trello__icon-check"
              />
          ...
          {task.desc && (
            <div
              className="trello__badge-description"
